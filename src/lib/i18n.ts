...
const translations = {
  en: {
    ...
    nfcTapSystem: "NFC Tap System",
    paused: "PAUSED",
    active: "ACTIVE",
    systemPausedDesc: "The system is completely paused. No NFC taps will be recorded.",
    systemActiveDesc: "The system is running normally. NFC taps are being recorded.",
  ...
  th: {
    ...
    nfcTapSystem: "ระบบ NFC Tap",
    paused: "หยุดชั่วคราว",
    active: "ทำงานปกติ",
    systemPausedDesc: "ระบบหยุดทำงานทั้งหมด จะไม่บันทึกการแตะ NFC",
    systemActiveDesc: "ระบบทำงานปกติ กำลังบันทึกการแตะ NFC",
    resumeSystem: "เปิดระบบ",
    pauseSystem: "หยุดระบบ",
